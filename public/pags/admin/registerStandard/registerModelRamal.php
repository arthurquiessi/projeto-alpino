<?php
    ...
    $coleta = mysqli_query($conn, "SELECT * FROM modelo_ramal order by modelo_ramal asc");
?>
<html lang="pt-br">
...
<head>
    ...
    <title>Registrar Modelo de Ramal - Admin</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="py-3 text-center">
                    <h5 class="display-5 m-2">MODELO DE RAMAL</h5>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
                                    ...
                                    <form action="../../../../src/db/admin/modeloRamal/insert.php" method="POST">
                                        <div class="form-row justify-content-center">
                                            <div class="form-group col-md-5">
                                                ...
                                                <input type="text" name="inputModelRamal" class="form-control" placeholder="Ramal">
                                            </div>
                                        </div>
                                        <div class="pt-3">
            ...
            <div class="col-md-4">
                <div class="py-3">
                    <table class="table">
                        <caption>Modelos de Ramais Cadastrados</caption>
                        <thead>
                            <tr class="table-info">
                                <th scope="col">MODELO RAMAL</th>
