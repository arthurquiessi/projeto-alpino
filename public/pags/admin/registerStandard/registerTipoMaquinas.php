<?php
    ...
    $coleta = mysqli_query($conn, "SELECT * FROM tipo_maquina order by tipo_maquina asc");
?>
<html lang="pt-br">
...
<head>
    ...
    <title>Registrar Tipo de Máquinas - Admin</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="py-3 text-center">
                    <h5 class="display-5 m-2">TIPOS DE MÁQUINAS</h5>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
                                    ...
                                    <form action="../../../../src/db/tipoMaquina/insert.php" method="POST">
                                        <div class="form-row justify-content-center">
                                            <div class="form-group col-md-5">
                                                ...
                                                <input type="text" name="inputTipoMaquina" class="form-control" placeholder="Tipo">
                                            </div>
                                        </div>
                                        <div class="pt-3">
            ...
            <div class="col-md-4">
                <div class="py-3">
                    <table class="table">
                        <caption>Tipo de Máquinas Cadastradas</caption>
                        <thead>
                            <tr class="table-info">
                                <th scope="col">TIPO DE MÁQUINAS</th>
