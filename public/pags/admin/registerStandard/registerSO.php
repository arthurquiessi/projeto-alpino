<?php
    ...
    $coleta = mysqli_query($conn, "SELECT * FROM sistema_operacional order by sistema_operacional asc");
?>
<html lang="pt-br">
...
<head>
    ...
    <title>Registrar Sistema Operacional - Admin</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="py-3 text-center">
                    <h5 class="display-5 m-2">SISTEMAS OPERACIONAIS</h5>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
                                    ...
                                    <form action="../../../../src/db/admin/sistemaOperacional/insert.php" method="POST">
                                        <div class="form-row justify-content-center">
                                            <div class="form-group col-md-5">
                                                ...
                                                <input type="text" name="inputSO" class="form-control" placeholder="S.O.">
                                            </div>
                                        </div>
                                        <div class="pt-3">
            ...
            <div class="col-md-4">
                <div class="py-3">
                    <table class="table">
                        <caption>Sistemas Operacionais Cadastrados</caption>
                        <thead>
                            <tr class="table-info">
