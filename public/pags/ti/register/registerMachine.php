                                    ...
                                    <form action="">
                                        ...
                                        <div class="form-row justify-content-center">
                                            <div class="form-group col-md-3">
                                                ...
                                                <select id="inputProcessador" class="form-control">
                                                    <option selected>Escolher...</option>
                                                    <option>...</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" class="form-control" id="inputMemoria">
                                            </div>
                                            <div class="form-group col-md-2">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <select id="inputSo" class="form-control">
                                                    <option selected>Escolher...</option>
                                                    <option>...</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-row justify-content-center">
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="inputNfCompra">
                                            </div>
                                            <div class="form-group col-md-3">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <select id="inputDistribuidora" class="form-control">
                                                    <option selected>Escolher...</option>
                                                    <option>...</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-row justify-content-center">
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="inputNfGarantia">
                                            </div>
                                            <div class="form-group col-md-3">
                                                <label for="inputGarantia">Data Garantia</label>
                                                <input type="text" class="form-control" id="inputGarantia">
                                            </div>
                                        </div>
                                        <div class="form-row justify-content-center">
                                            <div class="form-group col-md-2">
