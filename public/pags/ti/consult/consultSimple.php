...
<body class="bg-light">
    <?php 
        include '../include/nav-consultSimple.php';
    ?>
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                <div class="py-2 text-center">
                    <h3 class="display-3 m-2">Consulta Simples</h3>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" name="inputTag" class="form-control" id="tag" readonly=“true”>
                            </div>
                            <div class="form-group col-md-3">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" name="inputOffice" class="form-control" id="inicio" readonly=“true”>
                            </div>
